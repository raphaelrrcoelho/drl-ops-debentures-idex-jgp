...
def _normalize_columns(df: pd.DataFrame, universe: str) -> pd.DataFrame:
    ...
    rename = {
        "Data": "date",
        "DebÃƒÂªnture": "debenture_id",
        "Debenture": "debenture_id",
        "Duration": "duration",
        "DuraÃƒÂ§ÃƒÂ£o": "duration",
        "ÃƒÂndice": "index_level",
        "Indice": "index_level",
        "ÃƒÂndice (nÃƒÂ­vel)": "index_level",
        "Indice (nÃƒÂ­vel)": "index_level",
        "Peso no ÃƒÂ­ndice (%)": "index_weight",
        "MTM ponderado (%)": "weighted_mtm",
        "VariaÃƒÂ§ÃƒÂ£o ponderada (%)": "weighted_return",
        ...
        "Numero": "number",
        "Rating": "rating",
        "NÃƒÂºmero ÃƒÂndice": "index_value",
    }
...
def _compute_duration_risk_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Duration Ãƒâ€” Spread interaction
